...
int digver (const char *filename)
{
    ...
    memset (m, 0, 256);
	if (rdx_akcrypto_sign_ver(encrypto, 256, m, RDX_RSA_VERIFY, def_priv_key, def_priv_key_len)) {
