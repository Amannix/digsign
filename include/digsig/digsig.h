...
char *theprogram = "digsig";


static char         thefilename[1024];	/*文件名*/
static FILE        *thefile;		    /*文件句柄*/
static Elf64_Ehdr   ehdr;		        /*文件头*/
static Elf64_Phdr  *phdrs;		        /*程序头表*/
static Elf64_Shdr  *shdrs;		        /*节头表*/
...
static int commit_changes(void);        //修改elf文件参数
static int modify_shdrs(void);          //修改并插入节头表
static int insert_sh_sig(void);         //插入密钥节
