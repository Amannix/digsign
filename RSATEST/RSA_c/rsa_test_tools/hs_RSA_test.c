...
int PrivateDecrypt(char *privkey,char *cipher,char *out_plain)
{
	...
	/*rsa_pri = PEM_read_bio_RSAPrivateKey(dec, NULL, NULL, NULL);*/
...
int main()
{
	...
	/*密钥生成实现*/
	Generate_RSA_Keys(g_nBits,pubkey,privkey);
	printf("\n%s",pubkey);
